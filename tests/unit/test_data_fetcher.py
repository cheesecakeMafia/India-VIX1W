...
class TestNSEDataFetcher:
    ...
    def test_fetch_option_chain_success(
        self, mock_get: Mock, fetcher: NSEDataFetcher, mock_nse_response: dict[str, Any]
    ) -> None:
    ...
    @patch("requests.Session.get")
    def test_fetch_option_chain_network_error(
        self, mock_get: Mock, fetcher: NSEDataFetcher
    ) -> None:

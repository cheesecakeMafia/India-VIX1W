...
class TestVIXCalculator:
    ...
    @pytest.mark.parametrize("underlying,expected", [
        (24975.0, 24950.0),  # Closer to 24950 (25 away) than 25000 (25 away) - first in list wins
        (25025.0, 25000.0), 
        (25075.0, 25050.0),
        (25125.0, 25100.0),
    ])
    def test_get_atm_strike_various_prices(self, calculator: VIXCalculator, underlying: float, expected: float) -> None:
    ...
    def test_organize_by_expiry_basic(self, calculator: VIXCalculator, sample_option_data: pd.DataFrame) -> None:

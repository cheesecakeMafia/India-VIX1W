...
class TestVIXWorkflow:
    ...
    def test_end_to_end_vix_calculation(
        self,
        mock_fetch: Mock,
        fetcher: NSEDataFetcher,
        calculator: VIXCalculator,
        realistic_nse_data: dict[str, Any],
    ) -> None:
    ...
    @patch("src.data_fetcher.NSEDataFetcher.fetch_option_chain")
    def test_workflow_with_filtered_data(
        self, mock_fetch: Mock, fetcher: NSEDataFetcher, calculator: VIXCalculator
    ) -> None:
    ...
    def test_error_handling_invalid_data(
        self, fetcher: NSEDataFetcher, calculator: VIXCalculator
    ) -> None:
    ...
    @patch("src.data_fetcher.NSEDataFetcher.fetch_option_chain")
    def test_workflow_data_consistency(
        self,
        mock_fetch: Mock,
        fetcher: NSEDataFetcher,
        calculator: VIXCalculator,
